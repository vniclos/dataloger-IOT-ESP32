...
function fncReset() {
 ...
 if (agree) {
  ...
  fncMsg("scnMsg", "Reset canceled", false);
  return false;
 }
}
//..................
function fncDelete(FileName) {
 ...
 if (agree) {
  ...
  document.getElementById("scnMsg").innerHTML = uri;
...
function fncCfggetConfigFill(valuesSharp) {
 ...
 document.getElementById("scnIdName").value = aValues[0];
 document.getElementById("scnIdLoc").value = aValues[1];
 document.getElementById("scnIdGps").value = aValues[2];
 if (aValues[3] == "ap") {
