...
body {background-color: #555; background-image: linear-gradient(#333, #555); padding: 5px;}
...
.fldtit,.fldvalue  {display:inline-block;min-width:100px; height:1.3rem;  }
.fldvalue{margin-left=1em; font-weight: bold;}
input {margin-top: 8px; margin-bottom:16px; box-sizing: border-box;}
...
table.tablegray tr:nth-child(even) {
  background: #DDDDDD;
}
...
table.tablegray thead th:first-child {
  border-left: none;
}

table.tablegray tfoot {
 font-size: 0.7rem;
  font-weight: bold;
  color: #FFFFFF;
  background: #444444;
